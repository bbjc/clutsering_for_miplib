...
def evaluate_a_function_and_store_it(function, time_limit, instance):
    ...
    if function == "best_estimate_BFS":
        ...
        sel_policy = "BFS"
    folder = f"search-strategy-generation-for-branch-and-bound-using-genetic-programming/data/MIPLIB2017/miplib/" # j'ai change les chemins d'acces aux instances 
    #instance_path = os.path.dirname(__file__) + "/" + folder + str(instance)
    instance_path = folder + str(instance)
